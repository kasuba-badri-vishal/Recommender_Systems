...
usr_mean = utility_matrix.mean(axis=1).to_numpy().reshape(-1,1)
item_mean = utility_matrix.mean(axis=0).to_numpy().reshape(-1,1)
...
def main(user=None, item=None):
    ...
    s += usr_mean[user][0]
    print("user mean rating:", usr_mean[user])
    print("item mean rating:", item_mean[item])
